...
date: 2026-05-22
type: synthesis
tags: [synthesis, advanx, nearstream, ventas, metodología]
auto_generated: true
related-projects:
  - "[[Advanx]]"
...
# Síntesis — El Método Diego: Diagnóstico → Demo → Acompañamiento

## Patrón Detectado

El mismo embudo de ventas de 3 pasos aparece en **3 proyectos distintos**, formulado de manera diferente pero estructuralmente idéntico:

### NearStream 3a iteración — `[[Otra Iteración Automatizar Capturistas para empresas]]`

```
Paso 1 — DIAGNÓSTICO GRATUITO:
  "Mandame tu excel, en 48 horas te mando un video de 3 minutos 
   mostrando lo que se puede ahorrar."

Paso 2 — DEMOSTRACIÓN SIN RIESGO:
  "Resuelve una tarea gratis, la más pequeña."
  "Una tarde de tu tiempo / Cero riesgo para ellos."

Paso 3 — EL PROYECTO GRANDE:
...
```
Paso 1 — DIAGNÓSTICO:
  "Propuesta: acompañamiento para tener 90% o más en el 
   cuestionario diagnóstico."

Paso 2 → 3 — ESTRUCTURA:
  "Objetivo: estructura rentable y escalable."
  (Modelo de Negocio → Optimización → Procesos → Talento → Flywheel)
```
